...
###############################################################################
# PT - Ramping Regressions TA6 | 2 and 3
###############################################################################
...
X1 = pyblp.Formulation('0 + prices', absorb = 'C(hour)') 
...
import os
dirn = r"C:\Users\Gloria\Documents\1_Paper\Publication\Replication\Python\Ramp2\off"
os.makedirs(dirn)
os.chdir(dirn)
...
path = r"C:\Users\Gloria\Documents\1_Paper\Publication\Replication\Python\Ramp2\off\stats22.xlsx"
...
#create directory inside python
import os
dirn = r"C:\Users\Gloria\Documents\1_Paper\Publication\Replication\Python\Ramp2\p1"
os.makedirs(dirn)
os.chdir(dirn)
...
path = r"C:\Users\Gloria\Documents\1_Paper\Publication\Replication\Python\Ramp2\p1\stats23.xlsx"
book = load_workbook(path)
writer = pd.ExcelWriter(path, engine = 'openpyxl')
writer.book = book
merge.to_excel(writer, sheet_name = 'one', index = True)
...
#create directory inside python
import os
dirn = r"C:\Users\Gloria\Documents\1_Paper\Publication\Replication\Python\Ramp2\p2"
os.makedirs(dirn)
os.chdir(dirn)
...
path = r"C:\Users\Gloria\Documents\1_Paper\Publication\Replication\Python\Ramp2\p2\stats24.xlsx"
book = load_workbook(path)
writer = pd.ExcelWriter(path, engine = 'openpyxl')
writer.book = book
merge.to_excel(writer, sheet_name = 'one', index = True)
...
X1 = pyblp.Formulation('0 + prices + week + month', absorb = 'C(hour)') 
X2 = pyblp.Formulation('0  + loadf') 
X3 = pyblp.Formulation('0 + fcost + fcoa + rampc') 
...
#panda stats
index = ['fcost', 'co2', 'rampc', 'price', 'week','month', 'loadf']
...
with pd.ExcelWriter('stats25.xlsx') as writer:
    offr.to_excel(writer, sheet_name = 'pt', index = True)
...
path = r"C:\Users\Gloria\Documents\1_Paper\Publication\Replication\Python\Ramp2\off\stats25.xlsx"
book = load_workbook(path)
writer = pd.ExcelWriter(path, engine = 'openpyxl')
writer.book = book
merge.to_excel(writer, sheet_name = 'one', index = True)
...
#create directory inside python
import os
dirn = r"C:\Users\Gloria\Documents\1_Paper\Publication\Replication\Python\Ramp3\p1"
os.makedirs(dirn)
os.chdir(dirn)
...
with pd.ExcelWriter('stats26.xlsx') as writer:
    p1r.to_excel(writer, sheet_name = 'pt', index = True)
...
path = r"C:\Users\Gloria\Documents\1_Paper\Publication\Replication\Python\Ramp3\p1\stats26.xlsx"
book = load_workbook(path)
writer = pd.ExcelWriter(path, engine = 'openpyxl')
writer.book = book
merge.to_excel(writer, sheet_name = 'one', index = True)
...
with pd.ExcelWriter('stats27.xlsx') as writer:
    p2r.to_excel(writer, sheet_name = 'pt', index = True)
...
path = r"C:\Users\Gloria\Documents\1_Paper\Publication\Replication\Python\Ramp2\p2\stats27.xlsx"
book = load_workbook(path)
writer = pd.ExcelWriter(path, engine = 'openpyxl')
writer.book = book
merge.to_excel(writer, sheet_name = 'one', index = True)
